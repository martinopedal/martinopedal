...
|------|-------------|----------|-------|-----------|
| [alz-checklist-queries](https://github.com/martinopedal/alz-checklist-queries) | ALZ checklist validation - 135 Azure Resource Graph queries for Landing Zone assessment | PowerShell | 1 | 2026-04-15 |
<!-- repos:more:end -->

## Closing

I use GitHub Copilot heavily. It drafts fast, but the architecture, constraints, and review are still mine. On the side I co-founded two craft breweries in Norway (Cervisiam, Krecher). Fermentation and infrastructure both reward tight feedback loops.
